...
const TRAIN_DATA_PATH = 'http://localhost:3000/datasets/pitch_type_training_data.csv';
const TEST_DATA_PATH = 'http://localhost:3000//datasets/pitch_type_test_data.csv';


// Constants from training data
const VX0_MIN = -16.84730801;
const VX0_MAX = 15.293;
const VY0_MIN = -145.5101983;
const VY0_MAX = -92.024;
const VZ0_MIN = -14.39684099;
const VZ0_MAX = 7.339;
const AX_MIN = -44.13169264;
const AX_MAX = 14.09;
const AY_MIN = 38.92098911;
const AY_MAX = 49.18;
const AZ_MIN = -48.825;
const AZ_MAX = -0.16985979;
...
async function predictSample(sample) {
    ...
    console.log('Predicted Values: ', result[0]);
